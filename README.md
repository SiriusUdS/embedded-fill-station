# Embedded Fill Station

> Implementation at the application layer for the fill station.
...
This repository contains all the code that is specific for both the STM32H747 and Raspberry Pi chip for the fill station at the application layer.  
